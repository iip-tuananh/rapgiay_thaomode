...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::group(['prefix' => 'product-rates'], function () {
            ...
            Route::post('/', 'Admin\ProductRateController@store')->name('product_rates.store');
            Route::post('/{id}/update', 'Admin\ProductRateController@update')->name('product_rates.update');
        });
