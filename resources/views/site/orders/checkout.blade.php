...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{ asset('plugins/fontawesome-free/css/all.min.css') }}" />
...
<body ng-app="App" ng-controller="CheckoutController" ng-cloak>
                ...
                <div class="sidebar-content">
                    <div class="order-summary order-summary-is-collapsed">
                        ...
                        <div class="order-summary-sections">
                                        ...
                                        <tr class="product" ng-repeat="item in cart">
                                            ...
                                            <td class="product-description">
                                                ...
                                                <div>
                                                    <div class="ajaxcart__qty input-group-btn">
                                                        <button type="button" class="ajaxcart__qty-adjust ajaxcart__qty--minus items-count" data-id="" data-qty="0" data-line="1" aria-label="-" ng-click="decrementQuantity(item); changeQty(item.quantity, item.id)" style="cursor: pointer;background-color: #338dbc;color: #fff; width: 30px; height: 24px; border-radius: 0px;">
                                                        -
                                                        </button>
                                                        <input type="text" name="updates[]" class="ajaxcart__qty-num number-sidebar" maxlength="3" ng-model="item.quantity" value="<%item.quantity%>" min="0" data-id="" data-line="1" aria-label="quantity" pattern="[0-9]*" ng-change="changeQty(item.quantity, item.id)" style="border: 1px solid #338dbc;border-radius: 0px; width: 50px; text-align: center; height: 24px;">
                                                        <button type="button" class="ajaxcart__qty-adjust ajaxcart__qty--plus items-count" data-id="" data-line="1" data-qty="2" aria-label="+" ng-click="incrementQuantity(item); changeQty(item.quantity, item.id)" style="cursor: pointer;background-color: #338dbc;color: #fff; width: 30px; height: 24px; border-radius: 0px;">
                                                        +
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="product-price">
                                                <div style="display: flex; gap: 20px; flex-direction: column;">
                                                    <a href="javascript:void(0)" ng-click="removeItemCart(item.id)" style="cursor: pointer; color: #fd4800; font-size: 20px;">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <span class="order-summary-emphasis" style="font-size: 16px; font-weight: 700;"><% item.price | number %>₫</span>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="order-summary-section order-summary-section-discount"
                                data-order-summary-section="discount" ng-if="currentUser">
                                    <div> Hiện bạn có <span style="font-weight: 700; color: #338dbc;"><% point | number %></span> điểm</div>
                                    <div>Bạn có muốn quy đổi điểm để thanh toán?</div>
                                    <div class="fieldset">
                                        <div class="field  ">
                                            <div class="field-input-btn-wrapper">
                                                <div class="field-input-wrapper">
                                                    <label class="field-label">Quy đổi điểm</label>
                                                    <input placeholder="Số điểm quy đổi (1 điểm = 1000đ)" class="field-input" size="30" min="0" maxLength="<% point %>"
                                                        type="text"
                                                        ng-model="pointInput"
                                                        ng-change="changePoint()"
                                                        value="" />
                                                </div>
                                                <button type="submit" ng-click="convertPoint()" style="cursor: pointer;"
                                                    class="field-input-btn btn btn-default btn-disabled">
                                                    <span class="btn-content">Quy đổi</span>
                                                    <i class="btn-spinner icon icon-button-spinner"></i>
                                                </button>
                                            </div>
                                        </div>
                ...
                <div class="main-content">
                    ...
                    <div class="step">
                                        ...
                                        <div class="field field-required field-two-thirds  ">
                                            <div class="field-input-wrapper">
                                                ...
                                                <input autocomplete="false" placeholder="Email" autocapitalize="off"
                                                    ...
                                                    ng-model="form.customer_email" value="" ng-disabled="currentUser"/>
                                                <span class="invalid-feedback d-block" role="alert"
                                                    ...
                                                    <div class="field field-required  ">
                                                        <div class="field-input-wrapper">
                                                            <label class="field-label"
                                                                for="billing_address_address1">Địa chỉ (Ví dụ: Số 3, Hoàng Đạo Thúy)</label>
                                                            <input placeholder="Địa chỉ (Ví dụ: Số 3, Hoàng Đạo Thúy)" autocapitalize="off"
                                                                spellcheck="false" class="field-input" size="30"
                        ...
                        <div class="step-footer" id="step-footer-checkout">
                            ...
                            <a class="step-footer-previous-link" href="{{ route('front.home-page') }}">
                                Quay lại
                            </a>
                        </div>
                    </div>
    ...
    <script>
        app.controller('CheckoutController', function($scope, $http, cartItemSync, $interval, $compile) {
            ...
            // xóa item trong giỏ
            $scope.removeItemCart = function (product_id) {
                jQuery.ajax({
                    type: 'GET',
        ...
        app.factory('cartItemSync', function ($interval) {
            ...
            cart.items = @json($cartCollection);
            cart.count = {{$cartCollection->sum('quantity')}};
            cart.total = {{$total}};
